...
describe('<CreateItem />', () => {
  ...
  it('handles state updating', () => {
    ...
    wrapper.find('#description').simulate('change', { target: { value: 'You need this in your life!!', name: 'description' } })
    expect(wrapper.find('CreateItem').instance().state).toMatchObject({
      title: 'Testing!!',
      price: 50000,
      description: 'You need this in your life!!'
    })
  })
  ...
  it('creates an item when the form is submitted', async () => {
    ...
    expect(Router.router.push).toHaveBeenCalledWith({ 'pathname': '/item', 'query': { 'id': 'hjvhjhj' } })
  })
})
